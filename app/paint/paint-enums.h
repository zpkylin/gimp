...
#define GIMP_TYPE_CLONE_MODE (gimp_clone_mode_get_type ())

GType gimp_clone_mode_get_type (void) G_GNUC_CONST;

typedef enum  /*< pdb-skip >*/
{
  GIMP_MODIFY_PERSPECTIVE_PLANE,        /*< desc="Modify Perspective Plane" >*/
