...
typedef struct _BrushNoiseInfo BrushNoiseInfo;
struct _BrushNoiseInfo
{
  double  freq;
  double  step_start;
  double  step_width;
...
void       set_have_default_brush   (int value);
...
int     gimp_brush_get_noise_mode   (void);
void    gimp_brush_get_noise_info   (BrushNoiseInfo * info);
void    gimp_brush_set_opacity      (double);
void    gimp_brush_set_spacing      (int);
void    gimp_brush_set_paint_mode   (int);
void    gimp_brush_set_noise_mode   (int);
void    gimp_brush_set_noise_info   (BrushNoiseInfo * info);
