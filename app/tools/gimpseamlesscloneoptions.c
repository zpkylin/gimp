 ...
 * Based on gimpcagetooloptions.c (C) Michael Muré <batolettre@gmail.com>
 *
...
gimp_seamless_clone_options_class_init (GimpSeamlessCloneOptionsClass *klass)
{
  ...
  GIMP_CONFIG_INSTALL_PROP_BOOLEAN (object_class, PROP_DEBUG_SHOW_MESH,
                                    "debug-show-mesh", NULL,
                                    FALSE,
                                          ...
                                          GParamSpec   *pspec)
{
  ...
  switch (property_id)
    {
    case PROP_DEBUG_SHOW_MESH:
      options->debug_show_mesh = g_value_get_boolean (value);
      break;
                                          ...
                                          GParamSpec *pspec)
{
  ...
  switch (property_id)
    {
    case PROP_DEBUG_SHOW_MESH:
      g_value_set_boolean (value, options->debug_show_mesh);
      break;
...
gimp_seamless_clone_options_gui (GimpToolOptions *tool_options)
{
  ...
  button = gimp_prop_check_button_new (config, "debug-show-mesh",
                                       _("Show the generated mesh"));
