...
query ()
{
 ...
 static GParamDef load_args[] =
  ...
  gimp_install_procedure ("rhythm_and_hues_toolbox_load_extension",
		    "Provides a Rhythm & Hues open dialog",
		    "Provides a Rhythm & Hues open dialog",
		    "Calvin Williamson",
		    "Calvin Williamson",
		    "1999",
		    "<Toolbox>/File/Open/PTS",
		    "",
		    PROC_EXTENSION,
		    load_nargs, 0, 
		    load_args, NULL);

  gimp_install_procedure ("rhythm_and_hues_image_load_extension",
		    "Provides a Rhythm & Hues save dialog",
		    "Provides a Rhythm & Hues save dialog",
		    "Calvin Williamson",
		    "Calvin Williamson",
		    "1999",
 ...
 gimp_install_procedure ("rhythm_and_hues_save_plugin",
		    "Provides a Rhythm & Hues save dialog",
		    "Provides a Rhythm & Hues save dialog",
		    "Calvin Williamson",
		    "Calvin Williamson",
 ...
 gimp_install_procedure ("rhythm_and_hues_save_as_plugin",
		    "Provides a Rhythm & Hues save dialog",
		    "Provides a Rhythm & Hues save dialog",
		    "Calvin Williamson",
		    "Calvin Williamson",
		    "1999",
		    "<Image>/File/Save as/PTS",
		    "FLOAT16_RGB*, FLOAT16_GRAY*",
		    PROC_PLUG_IN,
		    save_nargs, save_nreturn_vals, 
		    save_args, save_return_vals);
     ...
     GParam **return_vals)
{
  ...
  *return_vals = values;
  ...
  if (strcmp (name, "rhythm_and_hues_toolbox_load_extension") == 0 ||
	strcmp (name, "rhythm_and_hues_image_load_extension") == 0 )
  {
#if 0 
      printf("process %d ", getpid());
